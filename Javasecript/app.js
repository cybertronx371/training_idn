...
//  kodisi if & else nilainya adalh nilai ujina 0 ke 100 nilai 0-100
let nilaiUjian = 0;
if (nilaiUjian >= 100) {
...
} else if (nilaiUjian >= 10) {
    console.log("tidak lulus");
} else {
    console.log("ngotak lah bro! Nilai kamu tidak masuk akal");
}

// switch case hari kerja
let hariKerja = "senin";
switch (hariKerja) {
    case "senin":
        console.log("mending turuu");          
        break;
    case "selasa":
        console.log("sama kaya kemarin ");
        break;
    case "rabu":        
        console.log("keluar dari rumah lihat matahari");
        break;
    case "kamis":
        console.log("masih sama malas ");
        break;
    case "jumat":           
        console.log("sedikt senang karena weekend");
        break;
    case "sabtu":
        console.log("libur akhir pekan besok");
        break;
    case "minggu":
        console.log("semangkat libur ");
        break;
    default:
